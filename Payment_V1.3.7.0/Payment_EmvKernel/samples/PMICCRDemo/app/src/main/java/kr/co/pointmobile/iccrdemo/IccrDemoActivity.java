...
public class IccrDemoActivity extends AppCompatActivity {
	
	private static final String TAG = IccrDemoActivity.class.getName();
	
	public static IccrManager iccrManager;
...
//	private final String selPSE = "";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mProgress = new ProgressDialog(IccrDemoActivity.this);
		mClient = MessengerClient.getInstance(getApplicationContext());
		mClient.init();

		showProgress(IccrDemoActivity.this, R.string.initializing, true);
...
//		if(iccrManager != null) {
//			iccrManager.runIccDetectPolling(false, null, 0);
//		}
		mClient.close();
		super.onDestroy();
	}
	...
	private View.OnClickListener mOnClickListener = new View.OnClickListener() {
		...
		public void onClick(View v) {
			...
			switch (v.getId()) {
				...
				case R.id.btnATR:
					Log.i(TAG, "ATR On++++");
					showProgress(IccrDemoActivity.this, R.string.processing, true);
...
//		String version = "v1.0.0";
	...
	{
		IccrDemoActivity.this.runOnUiThread(new Runnable()
		{
			@Override
			public void run()
			{
	...
	class AsyncMasterConnect extends AsyncTask<Void, Void, Boolean>
	{
		...
		protected Boolean doInBackground(Void... params)
		{
			...
			iccrManager.initIccrDemo(getApplicationContext(), getFilesDir().getPath());
		...
		protected void onPostExecute(Boolean aBoolean) {
			...
			showProgress(IccrDemoActivity.this, R.string.initializing, false);
		}
	}
	...
	class AsyncAttrOn extends AsyncTask<Void, Void, byte[]>
	{
		...
		protected void onPostExecute(byte[] result)
		{
			...
			if(result != null)
			{
				...
				resultATR += Utils.bytesToNibble(result, 1, result[0]);

				viewResult.setText(resultATR);
			}

			showProgress(IccrDemoActivity.this, R.string.processing, false);
		}
	}
	...
	class AsyncSendAPDU extends AsyncTask<String, Void, byte[]>
	{
		...
		protected byte[] doInBackground(String... params)
		{
			...
			else
			{
				...
				cAPDU = Utils.nibbleToHex(strAPDU);
			}
...
//			if (ret != 0)
//			{
//				showLogResult("@ EmvLib_BeforeTrans" + "(" + ret + ") \n", true);
//			}
//			long TransNo = 0L;
//			ret = EmvLib_AppSel((byte) 0/*slot*/, TransNo);
//			if (ret != 0)
//			{
//				showLogResult("@ EmvLib_AppSel fail!" + "(" + ret + ") \n", false);
//			}
			...
			if((ret = EmvLib_GetTLV("57", track2, len)) == 0)
			{
				...
				track2 = Utils.hexToNibbleBytes(val);
			}
			else
			{
				track2 = null;
